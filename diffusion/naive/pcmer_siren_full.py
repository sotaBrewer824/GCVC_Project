...
class FastAttention(nn.Module):                                                                                                      #nn.ReLU()
    def __init__(self, dim_heads, nb_features = None, ortho_scaling = 0, causal = False, generalized_attention = False, kernel_fn = Sine(w0=1), qr_uniform_q = False, no_projection = False):
        super().__init__()
